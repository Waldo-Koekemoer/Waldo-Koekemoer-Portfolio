			...
			<div class="updated notice notice-get-started-class is-dismissible" data-notice="get_started">
					...
					<div class="formula-getting-started-notice clearfix">
						...
						<div class="formula-theme-notice-content">
							...
							<p class="plugin-install-notice"><?php echo sprintf( __( 'To take full advantage of all the features of this theme, please install and activate the <strong>AWP Companion</strong> plugin, then enjoy this theme.', 'formula' ) ); ?></p>
