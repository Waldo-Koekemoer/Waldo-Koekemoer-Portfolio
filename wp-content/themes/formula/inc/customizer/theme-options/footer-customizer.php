<?php
	include('customizer-callback/footer-typo.php');
	// Footer copyright
	$wp_customize->add_setting('formula_footer_copyright_text',array(
	...
	$wp_customize->add_control('formula_footer_copyright_text', array(
