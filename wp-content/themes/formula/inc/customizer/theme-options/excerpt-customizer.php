<?php
	$wp_customize->add_setting( 'formula_excerpt_length', array(
		'capability' => 'edit_theme_options',
		'default' => 30,
		'sanitize_callback' => 'absint',
	) );

	$wp_customize->add_control( 'formula_excerpt_length', array(
		'type'		=> 'number',
	...
	$wp_customize->add_setting( 'formula_excerpt_more_text', array(
		'capability'		=> 'edit_theme_options',
		'sanitize_callback'	=> 'sanitize_text_field',
		'default'			=> esc_html__( 'Continue reading', 'formula' ),
	) );
	
	$wp_customize->add_control( 'formula_excerpt_more_text', array(
