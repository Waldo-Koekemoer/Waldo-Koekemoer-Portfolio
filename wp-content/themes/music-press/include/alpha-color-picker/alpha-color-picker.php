...
class Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			...
			get_stylesheet_directory_uri() . '/include/alpha-color-picker/alpha-color-picker.js',
		...
		wp_enqueue_style(
			...
			get_stylesheet_directory_uri() . '/include/alpha-color-picker/alpha-color-picker.css',
