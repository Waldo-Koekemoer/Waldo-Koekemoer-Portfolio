		...
		function awp_companion_awpbusinesspress_main_slider_default_content( $wp_customize ) {
			...
			if ( ! empty( $awpbusinesspress_main_slider_data ) ) {
				...
				$awpbusinesspress_main_slider_data->default = json_encode(
					array(
						array(
							'title'        => esc_html__( 'WELCOME TO HOME INTERIOR', 'awp-companion' ),
							'text'         => esc_html__( 'Start Your Journey With Home Interior WordPress Theme', 'awp-companion' ),
							'button_text'  => __( 'Know More', 'awp-companion' ),
							'link'         => '#',
							'image_url'    => awp_companion_plugin_url . '/inc/awpbusinesspress/img/slider/homedecor1.jpg',
							'open_new_tab' => 'no',
							'id'           => 'customizer_repeater_56d7ea7f40b10',
						),
						array(
							'title'        => esc_html__( 'BEAUTIFUL HOME DESIGNS', 'awp-companion' ),
							'text'         => esc_html__( 'Growing To Meet Your Real Needs', 'awp-companion' ),
							'button_text'  => __( 'Check it out', 'awp-companion' ),
							'link'         => '#',
							'image_url'    => awp_companion_plugin_url . '/inc/awpbusinesspress/img/slider/homedecor2.jpg',
							'open_new_tab' => 'no',
				...
				$awpbusinesspress_top_info_data->default = json_encode(
					array(
						array(
							...
							'title'        => esc_html__( 'OFFICE ADDRESS', 'awp-companion' ),
				...
				$awpbusinesspress_service_data->default = json_encode(
					array(
						array(
							...
							'title'        => esc_html__( 'PERFECT HOME', 'awp-companion' ),
							...
							'image_url'    => awp_companion_plugin_url . 'inc/awpbusinesspress/img/service/service-home1.jpg',
							'link'         => '#',
							'open_new_tab' => 'no',
							'id'           => 'customizer_repeater_56d7ea7f40b15',
						),
						array(
							...
							'title'        => esc_html__( 'DECORATIONS', 'awp-companion' ),
							'text'         => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua quos cupid',
							'choice'       => 'customizer_repeater_image',
							'image_url'    => awp_companion_plugin_url . 'inc/awpbusinesspress/img/service/service-home2.jpg',
							'link'         => '#',
							'open_new_tab' => 'no',
							'id'           => 'customizer_repeater_56d7ea7f40b16',
						),
						array(
							...
							'title'        => esc_html__( 'INTERIOR WORK', 'awp-companion' ),
							'text'         => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua quos cupid',
							'choice'       => 'customizer_repeater_image',
							'image_url'    => awp_companion_plugin_url . 'inc/awpbusinesspress/img/service/service-home3.jpg',
							'link'         => '#',
							'open_new_tab' => 'no',
							'id'           => 'customizer_repeater_56d7ea7f40b17',
						),
