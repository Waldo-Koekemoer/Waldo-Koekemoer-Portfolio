...
// Child Theme Formula Dark.
if ( 'Formula Dark' == $activate_theme ) {
	require awp_companion_plugin_dir . 'inc/formula/customizer/formula-dark-default-data/awp-companion-formula-dark-customizer-default.php';
}
// Child Theme Formula light.
if ( 'Formula Light' == $activate_theme ) {
	require awp_companion_plugin_dir . 'inc/formula/customizer/formula-light-default-data/awp-companion-formula-light-customizer-default.php';
}
// Child Theme Metaverse.
if ( 'Metaverse' == $activate_theme ) {
	require awp_companion_plugin_dir . 'inc/formula/customizer/metaverse-default-data/awp-companion-metaverse-customizer-default.php';
}

if ( 'Formula' == $activate_theme ) {
	// Slider Default Data.
			...
			function formula_main_slider_default_content( $wp_customize ) {
				...
				if ( ! empty( $formula_main_slider_data ) ) {
					$formula_main_slider_data->default = json_encode(
						array(
							array(
								'title'          => esc_html__( 'Give Wings To Your Imaginations', 'formula' ),
								'subtitle'       => esc_html__( 'Explore Your Creativity', 'formula' ),
								'text'           => esc_html__( 'Take your dreams and imagination to the next level of your expectations.', 'formula' ),
								'button_text'    => __( 'Build Something Creative ', 'formula' ),
								'link'           => '#',
