<?php 
	...
	$option_names = array(
		...
		?>
		<style>
		#wpsm_progress_b_row_<?php echo esc_attr($postId); ?>{
	    /*overflow:hidden;*/
	    display:block;
	    width:100%;
		...
		<div class="wpsm_progress_b_row" id="wpsm_progress_b_row_<?php echo esc_attr($postId); ?>">
			<div class="row">
			<?php 
			if($TotalCount>0) 
			{
				...
				echo "<h3> No Progress Bar Found </h3>";
			}
