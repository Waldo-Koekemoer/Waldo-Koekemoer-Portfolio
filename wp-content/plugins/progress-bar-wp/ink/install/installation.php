...
function dazz_pb_b_review() {
	...
	<div class="notice notice-info is-dismissible dazz-pb-b-review-notice">
		<div style="float:left;margin-right:10px;margin-bottom:5px;">
			<img style="width:100%;width: 150px;height: auto;" src="<?php echo esc_url(progress_bar_wp_directory_url.'assets/images/pb.jpg'); ?>" />
		</div>
		<p style="font-size:18px;"><?php esc_html_e('Hi! We saw you have been using ',progress_bar_wp_text_domain); ?><strong><?php esc_html_e('Progress Bar plugin',progress_bar_wp_text_domain); ?></strong><?php esc_html_e(' for a few days and wanted to ask for your help to ',progress_bar_wp_text_domain); ?><strong><?php esc_html_e('make the plugin better',progress_bar_wp_text_domain); ?></strong><?php esc_html_e('. We just need a minute of your time to rate the plugin. Thank you!',progress_bar_wp_text_domain); ?></p>
		<p style="font-size:18px;"><strong><?php _e( '~ Dazzlersoft', '' ); ?></strong></p>
		<p style="font-size:19px;"> 
			<a style="color: #fff;background: #ef4238;padding: 5px 7px 4px 6px;border-radius: 4px;" href="https://wordpress.org/support/plugin/progress-bar-wp/reviews/?filter=5#new-post" class="dazz-pb-b-dismiss-review-notice dazz-pb-b-review-out" target="_blank" rel="noopener"><?php esc_html_e('Rate the plugin',progress_bar_wp_text_domain); ?></a>&nbsp; &nbsp;
				...
				<div class="texture-layer">
					<div class="row col-md-12">
							<div class="wpsm_ac_h_b col-md-6" style="text-align:left">
								<a class="btn btn-danger btn-lg " href="https://wpshopmart.com/plugins/progress-bar-pro/" target="_blank"><?php esc_html_e('Get Pro Version',progress_bar_wp_text_domain); ?></a><a class="btn btn-success btn-lg " href="http://demo.wpshopmart.com/progress-bar-pro-demo/" target="_blank"><?php esc_html_e('View Demo',progress_bar_wp_text_domain); ?></a>
							</div>								
							<div class="col-md-6" style="text-align:left">							
								<h1 style="color:#fff;font-size:34px;font-weight:800"><?php esc_html_e('ProgressBar/SkillBar Pro Plugin Features',progress_bar_wp_text_domain); ?></h1>							
							</div>					
							...
							<div class="row col-md-12" style="padding-bottom:20px;">
									...
									<div class="col-md-3 pad-o">
										<ul>
											<li> <i class="fa fa-check"></i><?php esc_html_e('32+ Design Templates',progress_bar_wp_text_domain); ?></li>
											<li> <i class="fa fa-check"></i><?php esc_html_e('Individual Color Scheme',progress_bar_wp_text_domain); ?></li>
									...
									<div class="col-md-3 pad-o">
										<ul>
								<li> <i class="fa fa-check"></i><?php esc_html_e('Circular Pie Progress bar',progress_bar_wp_text_domain); ?></li>
								<li> <i class="fa fa-check"></i><?php esc_html_e('Half Pie Progress bar',progress_bar_wp_text_domain); ?></li>
								<li> <i class="fa fa-check"></i><?php esc_html_e('Gage Layout',progress_bar_wp_text_domain); ?></li>
								<li> <i class="fa fa-check"></i><?php esc_html_e('Vertical Progress bar Layout',progress_bar_wp_text_domain); ?></li>
									...
									<div class="col-md-3 pad-o">
							<ul>	
								<li> <i class="fa fa-check"></i><?php esc_html_e('Tested with 500+ Themes',progress_bar_wp_text_domain); ?></li>
								<li> <i class="fa fa-check"></i><?php esc_html_e('Gutenberg Compatible',progress_bar_wp_text_domain); ?></li>
								<li> <i class="fa fa-check"></i><?php esc_html_e('Unlimited Shortcode',progress_bar_wp_text_domain); ?></li>			
								<li> <i class="fa fa-check"></i><?php esc_html_e('Drag And Drop Builder',progress_bar_wp_text_domain); ?></li>
								<li> <i class="fa fa-check"></i><?php esc_html_e('Advance Animation',progress_bar_wp_text_domain); ?></li>
								
							</ul>
									</div>
									<div class="col-md-3 pad-o">
							<ul>		
								<li> <i class="fa fa-check"></i><?php esc_html_e('Fully Color Customization',progress_bar_wp_text_domain); ?></li>
								<li> <i class="fa fa-check"></i><?php esc_html_e('Widget Option',progress_bar_wp_text_domain); ?></li>
